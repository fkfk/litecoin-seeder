...
static const string mainnet_seeds[] = {"dnsseed.vipstarcoin.jp", ""};
static const string testnet_seeds[] = {"test.dnsseed.vipstarcoin.jp", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 31915), true);
  }
  do {
